...
import { q as getNormalizedURL, u as getOrigin, v as attachRouterServerSsrUtils, w as createSerializationAdapter, x as createRawStreamRPCPlugin, i as isNotFound, b as isRedirect, y as isResolvedRedirect, z as mergeHeaders, A as executeRewriteInput, C as defaultSerovalPlugins, D as makeSerovalPlugin, a as rootRouteId, E as defineHandlerCallback } from "../_chunks/_libs/@tanstack/router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-DHyIFMN8.mjs");
...
async function loadEntries() {
  const routerEntry = await import("./router-CXRKz_nm.mjs").then((n) => n.r);
  const startEntry = await import("./start-BwgIKFGm.mjs");
...
const ROUTER_BASEPATH = "read-one-piece";
const SERVER_FN_BASE = "/read-one-piece/_serverFn/";
